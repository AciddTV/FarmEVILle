...
namespace CryEngine.Game
{
	...
	/// </summary>
	public class Game : IGameUpdateReceiver, IDisposable                //This is all just a bunch of dev mumbo jumbo but if you wanna just throw it in there to make it look cool you can.
	{
